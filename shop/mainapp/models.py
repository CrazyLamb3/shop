...
class Product(models.Model):
    ...
    short_desc = models.CharField(verbose_name='краткое описание', max_length=255, blank=True, null=True)
    ...
    main_characteristics = models.TextField(verbose_name='основные характеристики', blank=True)
    tech_characteristics = models.TextField(verbose_name='технические характеристики', blank=True)
